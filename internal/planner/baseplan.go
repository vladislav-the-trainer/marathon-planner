...
var BasePlan = [20]BaseWeek{
	...
	{Sessions: [4]BaseSession{
		{SessionInterval, "5 x 400m, rest 20 sec", 2.0},
	...
	// Week 2
	{Sessions: [4]BaseSession{
		{SessionInterval, "4 x 800m, rest 400m jog", 4.4}, // 4×800m + 3×400m = 4.4km
	...
	// Week 3
	{Sessions: [4]BaseSession{
		{SessionInterval, "4 x 600m, rest 200m jog", 3.0}, // 4×600m + 3×200m = 3.0km
	...
	// Week 4
	{Sessions: [4]BaseSession{
		{SessionInterval, "12 x 200m, rest 200m jog", 4.6}, // 12×200m + 11×200m = 4.6km
	...
	// Week 5
	{Sessions: [4]BaseSession{
		{SessionInterval, "3 x 1600m, rest 400m jog", 5.6}, // 3×1600m + 2×400m = 5.6km
	...
	// Week 6
	{Sessions: [4]BaseSession{
		{SessionInterval, "4 x 800m, rest 2 min jog", 3.2}, // time-based rest, no distance added
	...
	// Week 7
	{Sessions: [4]BaseSession{
		{SessionInterval, "Ladder: 1200m+1000m+800m+600m+400m, rest 200m jog", 4.8}, // 4000m + 4×200m = 4.8km
	...
	// Week 8
	{Sessions: [4]BaseSession{
		{SessionInterval, "5 x 1000m, rest 400m jog", 6.6}, // 5×1000m + 4×400m = 6.6km
	...
	// Week 10
	{Sessions: [4]BaseSession{
		{SessionInterval, "2 x 1200m + 4 x 800m, rest 2 min jog", 5.6}, // 2.4km + 3.2km, time-based rest
		{SessionTempo, "Easy 1.5km + 8km at marathon pace + Easy 1.5km", 11.0},
		{SessionGym, "Full body strength training", 0},
	...
	// Week 11
	{Sessions: [4]BaseSession{
		{SessionInterval, "6 x 800m, rest 90 sec jog", 4.8}, // time-based rest, no distance added
	...
	// Week 12
	{Sessions: [4]BaseSession{
		{SessionInterval, "2 sets of 6 x 400m, rest 90 sec inside set, 2:30 between sets", 4.8}, // 12×400m, time-based rest
		{SessionTempo, "Easy 3km + 5km at 5km pace + Easy 1.5km", 9.5},
		{SessionGym, "Full body strength training", 0},
	...
	// Week 13
	{Sessions: [4]BaseSession{
		{SessionInterval, "2 x 1600m + 2 x 800m, rest 60 sec jog", 4.8}, // 3.2km + 1.6km, time-based rest
	...
	// Week 14
	{Sessions: [4]BaseSession{
		{SessionInterval, "4 x 1200m, rest 2 min jog", 4.8}, // time-based rest, no distance added
	...
	// Week 15
	{Sessions: [4]BaseSession{
		{SessionInterval, "1000m+2000m+1000m+2000m, rest 400m jog", 7.2}, // 6000m + 3×400m = 7.2km
	...
	// Week 17
	{Sessions: [4]BaseSession{
		{SessionInterval, "10 x 400m, rest 400m jog", 7.6}, // 10×400m + 9×400m = 7.6km
	...
	// Week 18
	{Sessions: [4]BaseSession{
		{SessionInterval, "8 x 800m, rest 90 sec jog", 6.4}, // time-based rest, no distance added
		{SessionTempo, "Easy 1.5km + 8km at marathon pace + Easy 1.5km", 11.0},
		{SessionGym, "Full body strength training", 0},
	...
	// Week 20 — race week
	{Sessions: [4]BaseSession{
		{SessionInterval, "6 x 400m, rest 400m jog", 4.4}, // 6×400m + 5×400m = 4.4km
